...
var site = {
  init: function init() {
    ...
    this.textEllipsis();
    this.swiper();
    this.dropdownAnimation(); // this.mobileMenu();
    // this.closeMobilMenu();
  },
    ...
    if ($('.slick-slider').length > 0) {
      ...
      sliders.each(function () {
        ...
        slider.slick({
          ...
          nextArrow: '<i class="icon-arrow-right slick-next"></i>' // responsive: [
          //     {
          //         breakpoint: 960,
          //         settings: {
          //           slidesToShow: 1,
...
__webpack_require__(/*! /Users/andreameszaros/code/RTMonline_sitebuild/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/andreameszaros/code/RTMonline_sitebuild/resources/sass/app.scss */"./resources/sass/app.scss");
